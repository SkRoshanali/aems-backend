...
import com.aems.security.JwtAuthenticationFilter;
import com.aems.security.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/chat/warmup").permitAll()  // Allow warmup without auth
